...
write.csv(results_simple, 'output/treatment_fixed_mutation/cont_neffectdrug_Rv0006_reg_results.csv')
...
write.csv(results_lineage, 'output/treatment_fixed_mutation/cont_neffectdrug_Rv0006_lineage_reg_results.csv')
...
write.csv(results_baseresist, 'output/treatment_fixed_mutation/cont_neffectdrug_Rv0006_baseresist_reg_results.csv')
...
write.csv(results_full, 'output/treatment_fixed_mutation/cont_neffectdrug_Rv0006_allcovars_reg_results.csv')
