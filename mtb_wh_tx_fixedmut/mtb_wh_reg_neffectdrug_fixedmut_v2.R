...
# Regressions: Predict fixed mutation based on number of effective drugs  # 
#-------------------------------------------------------------------------#
...
write.csv(results_simple, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_reg_results_v2.csv')
...
write.csv(results_lineage, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_lineage_reg_results_v2.csv')
...
write.csv(results_baseresist, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_baseresist_reg_results_v2.csv')
...
write.csv(results_full, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_allcovars_reg_results_v2.csv')
