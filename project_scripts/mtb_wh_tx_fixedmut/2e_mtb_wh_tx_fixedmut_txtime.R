...
write.csv(results_simple, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_txtime_reg_results.csv')
...
write.csv(results_baseresist, 'output/treatment_fixed_mutation/cont_neffectdrug_fixedmut_baseresist_txtime_reg_results.csv')
