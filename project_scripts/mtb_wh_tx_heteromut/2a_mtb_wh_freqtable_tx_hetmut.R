...
write.csv(all_freq, 'output/treatment_hetero_mutation/frequency_table.csv')
...
write.csv(all_freq_strat, 'output/treatment_hetero_mutation/frequency_table_strat.csv')
